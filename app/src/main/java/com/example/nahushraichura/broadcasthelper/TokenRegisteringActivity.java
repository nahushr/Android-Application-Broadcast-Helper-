...
class TokenRegisteringActivity  extends AsyncTask<String, Void, String>{
    private Context context;
    private int byGetOrPost = 0;
    public String line="";

    //flag 0 means get and 1 means post.(By default it is get.)
    public TokenRegisteringActivity(Context context,int flag) {
    ...
    protected String doInBackground(String... arg0) {
        if(byGetOrPost == 0){ //means by Get Method
            ...
            try{
                ...
                String link = "http://nahushrai.esy.es/dbit_token.php?token="+token;
